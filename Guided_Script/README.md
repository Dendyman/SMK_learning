...
![](./media/image24.png){width="7.059271653543307in"
...
![](./media/image25.png){width="6.488888888888889in"
...
![](./media/image26.png){width="6.5in" height="2.964583333333333in"}
...
![](./media/image38.png){width="6.5in" height="1.913888888888889in"}
...
![](./media/image39.png){width="6.5in" height="3.317361111111111in"}

Сохраните результат

![](./media/image40.png){width="6.5in" height="3.2993055555555557in"}

Расположите текст по центру, поменяв свойства тестового поля как на
картинке **LAYOUT -\> Text Align -\> center**:

![](./media/image41.png){width="6.5in" height="2.120138888888889in"}
...
![](./media/image42.png){width="6.5in" height="3.6465277777777776in"}

Для элемента Image увяжите свойство **Source** картинки с переменной
**PAGE VARIABLE: photo_path**:

![](./media/image43.png){width="6.5in" height="3.854861111111111in"}

Далее поменяйте размеры картинки на фиксированные:

![](./media/image44.png){width="6.5in" height="3.3881944444444443in"}

И расположите картинку по центру:

![](./media/image45.png){width="6.5in" height="3.4569444444444444in"}
...
![](./media/image46.png){width="6.5in" height="3.3291666666666666in"}

В поле поиска напишем «covert file to base64» и выберем найденный
элемент:

![](./media/image47.png){width="6.5in" height="2.308333333333333in"}

Далее установим компонент нажав **INSTALL**:

![](./media/image48.png){width="6.5in" height="2.5277777777777777in"}

После этого, элемент появится во вкладке INSTALLED:

![](./media/image49.png){width="5.861757436570429in"
...
![](./media/image52.png){width="6.5in" height="4.2444444444444445in"}

И сохранить.

Для элемента **DIALOG: Alert** задайте текст "**failed to take photo**":

![](./media/image53.png){width="6.5in" height="3.2958333333333334in"}

Сохраните проект:

![](./media/image54.png){width="6.5in" height="1.7201388888888889in"}
...
![](./media/image55.png){width="6.5in" height="2.3652777777777776in"}
...
![](./media/image56.png){width="6.5in" height="3.540277777777778in"}

Для элемента Create Record выберем resource name: Blobstorage:

![](./media/image57.png){width="6.5in" height="2.2534722222222223in"}
...
![](./media/image58.png){width="6.497222222222222in"
height="4.097916666666666in"}

Для Alert успешного создание записи в БД выводим сообщение успеха -
***Uploaded***:

![](./media/image59.png){width="6.5in" height="3.9923611111111112in"}

В случае неуспешной записи в БД выводим сообщение -- ***Failed to
Upload***:

![](./media/image60.png){width="6.5in" height="4.221527777777778in"}

В случае неуспешной ковертации изображения выводим сообщение --
***failed to convert***:

![](./media/image61.png){width="6.5in" height="3.783333333333333in"}

Сохраняем весть проект:

![](./media/image62.png){width="6.5in" height="1.9638888888888888in"}
...
![](./media/image63.png){width="6.5in" height="3.14375in"}
...
![](./media/image64.png){width="6.488888888888889in"
